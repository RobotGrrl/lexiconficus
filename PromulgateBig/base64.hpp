 ...
 */
unsigned int encode_base64_length( int input_length);
 ...
 */
unsigned int decode_base64_length( char input[]);
 ...
 */
unsigned int encode_base64( char input[], unsigned int input_length,  char output[]);
 ...
 */
unsigned int decode_base64( char input[],  char output[]);
